...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("inkwaycoin-ext-ip");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "inkwaycoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    {"crypto1.lnkx.inkwayusa.com", "crypto1.lnkx.inkwayusa.com"},
    {"crypto2.lnkx.inkwayusa.com", "crypto2.lnkx.inkwayusa.com"},
    {"104.131.133.211", "104.131.133.211"},
    {"195.85.32.117", "95.85.32.117"},
    {"1104.131.17.243", "104.131.17.243"},
};

void ThreadDNSAddressSeed(void* parg)
{
    // Make this thread recognisable as the DNS seeding thread
    RenameThread("inkwaycoin-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("inkwaycoin-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("inkwaycoin-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("inkwaycoin-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. inkwaycoin is probably already running."), addrBind.ToString().c_str());
        else
